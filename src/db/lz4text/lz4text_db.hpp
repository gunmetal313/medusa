#ifndef DB_LZ4TEXT_HPP
#define DB_LZ4TEXT_HPP
...
#ifdef db_lz4text_EXPORTS
#  define DB_LZ4TEXT_EXPORT __declspec(dllexport)
#else
#  define DB_LZ4TEXT_EXPORT __declspec(dllimport)
#endif
#else
#define DB_LZ4TEXT_EXPORT
#endif

class LZ4TextDatabase : public medusa::Database
{
public:
  ...
  LZ4TextDatabase(void);
  virtual ~LZ4TextDatabase(void);
...
extern "C" DB_LZ4TEXT_EXPORT Database* GetDatabase(void);

#endif // !DB_LZ4TEXT_HPP
